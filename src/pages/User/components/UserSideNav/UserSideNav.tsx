...
import { getAvatarUrl } from 'src/utils/ultil'
    ...
    <div>
      <div className='flex items-center  border-b border-b-gray-200 py-4'>
        ...
        <div className='flex-grow overflow-hidden pl-4'>
          <div className='mb-1 truncate font-semibold  text-gray-600 line-clamp-1 '>{profile?.email}</div>
