...
import { formatCurrency, formatNumberToSocialStyle, getIdFromNameId, rateSale } from 'src/utils/ultil'
...
const ProductDetail = () => {
  ...
  return (
    <div className='bg-gray-200 py-6'>
            ...
            <div className=' col-span-12 md:col-span-5'>
              ...
              <div className='relative mt-4 grid grid-cols-5 gap-1'>
                ...
                {currentImages.map((img) => {
                  const isIsActive = img === activeImage
                  return (
                    <div className='relative w-full pt-[100%]' key={img} onMouseEnter={() => chooseActive(img)}>
                      ...
                      />
                      {isIsActive && <div className='absolute inset-0 border-2 border-orange'></div>}
                    </div>
                  )
                })}
                <button
      ...
      <div className='mt-8'>
        <div className='container'>
          <div className='uppercase text-gray-400'>{t('related products')}</div>
          {productsData && (
